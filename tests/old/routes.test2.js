...
describe('Test des routes utilisateur', () => {
  it('GET / devrait renvoyer home.html', done => {
    ...
    // Effectuer d'autres assertions sur le contenu HTML de la page si nécessaire
  });
  ...
  // Ajouter d'autres tests pour les autres méthodes HTTP et les scénarios spécifiques
